    ...
    mainSteps = [
      {
        ...
        inputs = {
          runCommand = [
            ...
            "import_dashboard \"17119\" \"K8s Cluster Overview (Prometheus)\"",
            "",
            "# Kubernetes Views - Modern kubernetes-mixin suite (Google SRE best practices)",
            "import_dashboard \"15760\" \"K8s / Views / Global\"",
            "import_dashboard \"15761\" \"K8s / Views / Namespaces\"",
            "import_dashboard \"15762\" \"K8s / Views / Nodes\"",
            "import_dashboard \"15763\" \"K8s / Views / Pods\"",
            "",
            "# Control Plane Health",
            "import_dashboard \"12006\" \"K8s / System / API Server\"",
            "",
            "# Karpenter-specific metrics for autoscaling insights",
            "import_dashboard \"14981\" \"K8s / Karpenter / Capacity\"",
            "",
            "# Modern Node metrics (replaces old Angular-based dashboard)",
            "import_dashboard \"13978\" \"Node Exporter / Full\"",
            "",
