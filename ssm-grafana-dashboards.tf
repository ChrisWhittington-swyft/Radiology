    ...
    mainSteps = [
      {
        ...
        inputs = {
          runCommand = [
            ...
            "  ",
            "  # Remove uid and id from dashboard JSON to force Grafana to create new dashboard",
            "  # This prevents overwriting existing dashboards with same UID",
            "  jq 'del(.uid, .id)' \"$${TEMP_DASHBOARD}\" > \"$${TEMP_DASHBOARD}.clean\"",
