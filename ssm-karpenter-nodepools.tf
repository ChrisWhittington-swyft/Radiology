    ...
    mainSteps = [
      {
        ...
        inputs = {
          ...
          runCommand = [
            ...
            "    echo \"[Karpenter] Checking resource status...\"",
            "    kubectl get ec2nodeclass default -o yaml | grep -A5 'status:' || echo 'No status available'",
            "    kubectl get nodepool default -o yaml | grep -A5 'status:' || echo 'No status available'",
